...
namespace JJTrailerStore.Areas.Admin.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,Name,Description,MetaTagDescription,MetaTagKeywords,ManufacturerImageID,Status")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,Name,Description,MetaTagDescription,MetaTagKeywords,ManufacturerImageID,Status")] Manufacturer manufacturer)
        {
            if (ModelState.IsValid)
            {
